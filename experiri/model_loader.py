# experiri/model_loader.py (v5 - Final)
import json
import os
import numpy as np

from experiri.players import HRMPlayer, SemanticHRMPlayer, ARCPlayer, OllamaPlayer
...
# ... (get_system_state and get_model_characteristics functions are unchanged) ...
...
def load_player(model_key: str):
    # ... (core load_player logic is unchanged) ...
